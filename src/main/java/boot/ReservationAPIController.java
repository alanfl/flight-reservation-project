...
public class ReservationAPIController {
    ...
    public Iterable<Reservation> searchReservations(
            @RequestParam(value="reservation_id", required=false) String[] reservation_ids) {
    ...
    public Reservation getReservation(@PathVariable("reservation_id") String reservation_id) {
